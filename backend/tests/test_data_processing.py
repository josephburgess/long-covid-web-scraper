...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_load_data(self):
        ...
        test_collection.insert_many([
            ...
            {'title': 'Article 2',
                'publication_date': 'Published 15 Jun 2021', 'source': 'BMJ'},
    ...
    def test_standardize_date(self):
        date1 = '2021 Aug 05'
        source1 = 'pubmed'
        self.assertEqual(self.data_processor.standardize_date(
            date1, source1), '2021-Aug-05')

        date2 = 'Published 10 Mar 2022'
        source2 = 'BMJ'
        self.assertEqual(self.data_processor.standardize_date(
            date2, source2), '2022-Mar-10')

        date3 = 'Published: July 20, 2020'
        source3 = 'The Lancet'
        self.assertEqual(self.data_processor.standardize_date(
            date3, source3), '2020-Jul-20')
